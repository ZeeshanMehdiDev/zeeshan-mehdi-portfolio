...
import reactnativeLogo from './assets/tech_logo/reactjs.png';
...
import flutterflowLogo from './assets/tech_logo/flutterflow.png';
...
export const SkillsInfo = [
  ...
  export const projects = [
    {
      id: 0,
      title: "AHK - Automated Home Kit",
      description:
        "A specialized Android mobile application developed in Kotlin for the Cyprus Electric System infrastructure. This innovative solution integrates advanced automation capabilities with comprehensive electrical system management, featuring intuitive user interfaces designed through Figma. The app provides real-time monitoring, automated control systems, and seamless integration with Cyprus electrical infrastructure for enhanced operational efficiency and user experience.",
      image: movierecLogo, // Using existing logo temporarily
      tags: ["Kotlin", "Android Development", "Figma Design", "Electrical Systems", "Automation", "Cyprus Infrastructure"],
      webapp: "https://play.google.com/store/apps/details?id=com.kakushin.ahk",
    },
    {
      id: 1,
    ...
    {
      id: 3,
      title: "PixelsJourney AI Art E-commerce",
      description:
        "A cutting-edge AI-generated art e-commerce platform where premium metal posters meet innovative technology. I developed and optimized the advanced filtering functionality, enabling users to seamlessly discover and purchase unique AI-generated artwork with enhanced search capabilities and category management.",
      image: csprepLogo, // Using existing logo temporarily
      tags: ["Medusa JS", "AI Integration", "E-commerce", "Filtering System", "Next.js", "PostgreSQL"],
      webapp: "https://pixelsjourney.com/il/en",
    },
    {
      id: 4,
      title: "BW Porcelain E-commerce",
      description:
        "A sophisticated porcelain and ceramics e-commerce platform built with Medusa.js. I successfully integrated the SendGrid plugin to implement automated order confirmation emails, enhancing customer communication and order management workflows upon order placement.",
      image: npmLogo, // Using existing logo temporarily
      tags: ["Medusa JS", "SendGrid Integration", "E-commerce", "Email Automation", "Order Management", "PostgreSQL"],
      webapp: "https://www.bwporcelain.it/",
    },
    {
      id: 5,
      title: "Heyyaa Online Marketplace",
      description:
        "A comprehensive marketplace built on top of Medusa.js 2.0, featuring advanced e-commerce capabilities and vendor management systems. Currently planning migration to Mercurjs for enhanced performance and scalability. The platform demonstrates robust marketplace architecture with multi-vendor support.",
      image: webverLogo, // Using existing logo temporarily
      tags: ["Medusa JS 2.0", "Marketplace", "Multi-vendor", "E-commerce", "Mercurjs Migration", "PostgreSQL"],
      webapp: "https://heyyaa.online/",
    },
    {
      id: 6,
      title: "Sookup Mobile Ecosystem",
      description:
        "A comprehensive mobile ecosystem comprising Seller App, Buyer App, and Digitizer App built with React Native and Expo. All apps are powered by the same Medusa.js backend, ensuring consistent data synchronization and seamless user experience across the entire marketplace ecosystem.",
      image: movierecLogo, // Using existing logo temporarily
      tags: ["React Native", "Expo", "Medusa JS", "Mobile Apps", "E-commerce", "Cross-platform"],
      webapp: "https://sookup-frontend-production.up.railway.app",
    },
    {
      id: 7,
